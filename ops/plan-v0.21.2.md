...
backers remain prospective until their proof material exists.
...
- It reflects a prospective operator pipeline without asserting completed
...
`v0.21.2` adds an "External Operators (proof pending)" section to
`docs/operators/maintainer-operated-sovereigns.md`:

- States that further operators and backers remain prospective until they prepare
  their own endpoints, treaties, and proof bundles.
- Defines the evidence required before a participant is named in the registry:
